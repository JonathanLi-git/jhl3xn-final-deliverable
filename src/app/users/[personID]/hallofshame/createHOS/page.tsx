...
import { getUser, createHOS } from "./helper";
    ...
    <div className="bg-zinc-100">
      ...
      <div className="flex justify-center w-screen h-screen ">
        <div className=" mt-20 mb-20 block grid grid-rows-7 grid-cols-1 w-1/3 text-zinc-900 ">
          ...
          <div className="flex grid grid-rows-3 flex h-36 w-full text-xl">
            <div className="w-full row-start-1 row-end-2">
              <p>Details</p>
            </div>
            <div>
              <textarea
                className="w-full border-2 max-h-48 border-zinc-500 rounded-md h-24"
                placeholder="Enter task name..."
                onChange={(event) => {
          ...
          <div className="text-left text-black font-light">
            <button
              ...
              onClick={() => {
                ...
                if(username !== undefined && details !== undefined)
                    createHOS(username, details);
                    router.push(`/users/${params.personID}/hallofshame/`);
              }}>
              Add 
            </button>
          </div>
